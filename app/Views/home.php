  ...
  <body>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="banner_taital_main">
                      ...
                      <p class="banner_text">
                        Tekno Expo adalah acara tahunan yang diselenggarakan oleh Himpunan Mahasiswa Fakultas Teknik dan ilmu Komputer (FTIK) Universitas Teknokrat Indonesia. Terdiri atas empat kategori, yaitu Desain Web, Pemrograman Game,
                        UI/UX, dan CTF.
                      </p>
    ...
    <div class="services_section">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h1 class="studies_taital">Kategori</h1>
          </div>
        </div>
      </div>
          ...
          <div class="contain">
            <div class="service_box">
              <div class="house_icon">
                ...
                <div class="up">
                  <p class="chunks_text">
                    Desain web adalah proses merancang tampilan untuk website. yang melibatkan pemilihan elemen visual, warna, tipografi, dan gambar, serta mempertimbangkan aspek navigasi, fungsionalitas, dan interaksi.
                  </p>
            ...
            <div class="service_box">
              <div class="house_icon">
                ...
                <div class="up">
                  <p class="chunks_text">
                    Pemrograman mobile adalah proses membuat aplikasi mobile seperti smartphone dan tablet. Melibatkan pengembangan aplikasi yang dapat dijalankan pada SO mobile seperti Android, iOS, atau Windows Mobile.
                  </p>
                  <div class="readmore_button"><a href="#">Read More</a></div>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="about_text_main">
                ...
                <p class="about_text">
                  Tekno Expo adalah acara tahunan yang diselenggarakan oleh Himpunan Mahasiswa Fakultas Teknik dan ilmu Komputer (FTIK) Universitas Teknokrat Indonesia. Terdiri atas empat kategori, yaitu Desain Web, Pemrograman Game, UI/UX,
                  dan CTF.
                </p>
    ...
    <div id="#documentation" class="card-section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h1 class="studies_taital" style="padding-top: 3em">Dokumentasi Tahunan</h1>
          </div>
        </div>
      </div>
    ...
    <div id="sponsor" class="layout_padding">
      <div class="sponsor-bg">
        <div class="bg-up" style="background-color: #001431">
          <h1 class="studies_taital">Sponsor</h1>
        </div>
    ...
    <div class="copyright_section">
      <div class="container">
        <p class="copyright_text">© 2023 All Rights Reserved, <a href="https://teknokrat.ac.id/">Universitas Teknokrat Indonesia</a></p>
      </div>
    </div>
