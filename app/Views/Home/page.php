...
<body>
    <nav class="navbarb">
        <div class="container">
            <div class="logo">
                <a href="#" class="btn btn-dark" onclick="goBack()"><i class="fa fa-arrow-left"></i></a>
                <a class="navbar-brand" data-placement="bottom"></a>
            </div>
        </div>
    </nav>
    <div class=" banner-container">
        <img src="/uploads/images/<?= $event['gambar_banner'] ?>" alt="Gambar Keterangan" class="banner-image">
        <h1><?= $event['nama'] ?></h1>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul class="list-group">
                            ...
                            <li id="button-kategori" class="list-group-item" data-toggle="modal"
                                data-target="#eventModal1" data-index=<?= $key ?>><?= $value['kategori'] ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                </div>
